...
--n4eme konkreetsetes linnades olevate isikute koondvanust
...
---kuvab esimeses reas välja toodud järjestuses ja kuvab Age-i TotalAge-iks
...
-- * asemel võib panna veel nimetusi
...
select Gender, City, sum(cast(Salary as int)) as TotalSalary, count (Id) as [Total Employee]
from Employees group by Gender, City
having cast(Salary as int) > 4000

-- loome tabeli, milles hakkame automaatselt nummerdama Id-d
create table Test1
(
Id int identity(1,1),
Value nvarchar(20)
...
-- kustutame ära City veeru Employees tabelist
...
select Name, Gender, Salary, DepartmentName
from Employees
right join Department -- võib kasutada ka LEFT OUTER JOIN
on Employees.DepartmentId = Department.Id
